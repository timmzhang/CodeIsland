...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "usage_entry_today": "Today's tokens:",
        "usage_view_details": "View details",
        "usage_detail_title": "Token Usage Details",
        "usage_range_days": "Last %d days",
        "usage_trend_days": "Last %d days trend",
        "usage_by_session_today": "Today by session",
        "usage_today": "Today",
        "usage_full_report": "Full report…",
        ...
        "browser_use_attention_title": "Browser Use",
        "browser_use_attention_possible": "may need confirmation",
        "browser_use_attention_body": "Codex started a page action. Open the original session to review.",
        "browser_use_attention_note": "Reminder only · CodeIsland cannot confirm for you",
        "browser_use_attention_open": "OPEN SESSION →",
        "always": "ALWAYS",
        ...
        // Usage stats window
        "usage_stats_title": "Token Usage",
        "usage_stats_ellipsis": "Token Usage...",
        "usage_seg_day": "Day",
        "usage_seg_week": "Week",
        "usage_range_weeks": "last %d weeks · to %@",
        "usage_tile_today": "TODAY TOKENS",
        "usage_tile_cost": "EQUIV. API COST",
        "usage_tile_cache": "CACHE HIT RATE",
        "usage_tile_sessions": "ACTIVE SESSIONS",
        "usage_delta_vs_yesterday": "vs yesterday",
        "usage_week_cumulative": "this week %@",
        "usage_cache_rw": "read %@ / write %@",
        "usage_tools_in_use": "%d tools in use",
        "usage_chart_daily": "Daily tokens · by tool",
        "usage_chart_weekly": "Weekly tokens · by tool",
        "usage_total_day": "Day total",
        "usage_total_week": "Week total",
        "usage_col_tool": "Tool / Model",
        "usage_col_input": "Input",
        "usage_col_output": "Output",
        "usage_col_cache_write": "Cache W",
        "usage_col_cache_read": "Cache R",
        "usage_col_cost": "Cost",
        "usage_col_share": "Share",
        "usage_row_total": "Total",
        ...
        "usage_tab_report": "Report",
        "usage_tab_insight": "Weekly Insight",
        "usage_insight_hero_title": "THIS WEEK'S TOKENS",
        "usage_insight_hero_sub": "%@ equivalent API cost",
        "usage_insight_vs_last_week": "vs last week",
        "usage_insight_daily_avg_peak": "Daily avg %@ · peak %@ %@",
        "usage_insight_heatmap_title": "Active hours · 2h per cell",
        "usage_insight_copy": "Copy as text",
        "usage_insight_copied": "Copied",
        "usage_insight_empty": "No data yet this week",
        "usage_insight_copy_line1": "This week's token usage: %@ (%@)",
        "usage_insight_copy_line1_no_cost": "This week's token usage: %@",
        "usage_insight_copy_delta": "vs last week: %@",
        "usage_insight_copy_projects": "Top projects: %@",
        "usage_insight_copy_tools": "Top tools: %@",
        "usage_insight_list_sep": ", ",
    ]
    ...
    private static let de: [String: String] = en.merging([
        ...
        "browser_use_attention_title": "Browser Use",
        "browser_use_attention_possible": "benötigt möglicherweise Bestätigung",
        "browser_use_attention_body": "Codex hat eine Seitenaktion gestartet. Öffne die ursprüngliche Sitzung zur Prüfung.",
        "browser_use_attention_note": "Nur Hinweis · CodeIsland kann nicht für dich bestätigen",
        "browser_use_attention_open": "SITZUNG ÖFFNEN →",
        "always": "IMMER",
    ...
    private static let zh: [String: String] = [
        ...
        "usage_entry_today": "今日 Token:",
        "usage_view_details": "查看详情",
        "usage_detail_title": "Token 用量详情",
        "usage_range_days": "近 %d 天",
        "usage_trend_days": "近 %d 天趋势",
        "usage_by_session_today": "今日按会话分布",
        "usage_today": "今日",
        "usage_full_report": "完整报表…",
        ...
        "allow_once": "允许一次",
        "browser_use_attention_title": "Browser Use",
        "browser_use_attention_possible": "可能需要确认",
        "browser_use_attention_body": "Codex 已发起页面操作，请前往原会话查看",
        "browser_use_attention_note": "仅作提醒 · CodeIsland 不会代为确认",
        "browser_use_attention_open": "前往处理 →",
        "always": "始终允许",
        ...
        // Usage stats window
        "usage_stats_title": "Token 用量",
        "usage_stats_ellipsis": "Token 用量…",
        "usage_seg_day": "日",
        "usage_seg_week": "周",
        "usage_range_weeks": "近 %d 周 · 至 %@",
        "usage_tile_today": "今日 TOKENS",
        "usage_tile_cost": "等效 API 成本",
        "usage_tile_cache": "CACHE 命中率",
        "usage_tile_sessions": "活跃会话",
        "usage_delta_vs_yesterday": "vs 昨日同时段",
        "usage_week_cumulative": "本周累计 %@",
        "usage_cache_rw": "读 %@ / 写 %@",
        "usage_tools_in_use": "%d 个工具在用",
        "usage_chart_daily": "每日 Token 消耗 · 按工具",
        "usage_chart_weekly": "每周 Token 消耗 · 按工具",
        "usage_total_day": "当日合计",
        "usage_total_week": "当周合计",
        "usage_col_tool": "工具 / 模型",
        "usage_col_input": "Input",
        "usage_col_output": "Output",
        "usage_col_cache_write": "Cache 写",
        "usage_col_cache_read": "Cache 读",
        "usage_col_cost": "等效成本",
        "usage_col_share": "占比",
        "usage_row_total": "合计",
        "usage_tool_other": "其他",
        ...
        "usage_tab_report": "报表",
        "usage_tab_insight": "周报洞察",
        "usage_insight_hero_title": "本周 TOKEN 消耗",
        "usage_insight_hero_sub": "%@ 等效 API 成本",
        "usage_insight_vs_last_week": "vs 上周",
        "usage_insight_daily_avg_peak": "日均 %@ · 峰值周%@ %@",
        "usage_insight_heatmap_title": "活跃时段 · 每格 2 小时",
        "usage_insight_copy": "复制文案",
        "usage_insight_copied": "已复制",
        "usage_insight_empty": "本周暂无数据",
        "usage_insight_copy_line1": "本周 Token 消耗：%@（%@）",
        "usage_insight_copy_line1_no_cost": "本周 Token 消耗：%@",
        "usage_insight_copy_delta": "环比上周：%@",
        "usage_insight_copy_projects": "Top 项目：%@",
        "usage_insight_copy_tools": "Top 工具：%@",
        "usage_insight_list_sep": "、",
    ]
    ...
    private static let zhHant: [String: String] = [
        ...
        "launch_at_login_error_title": "無法更新登入項目",
        "launch_at_login_transient_error": "無法從暫時建置的版本啟用登入時啟動。請開啟已安裝的 CodeIsland 後重試。",
        "launch_at_login_update_failed": "無法更新登入時啟動：%@",
        ...
        "usage_today_title": "今日 Token 用量",
        "usage_excl_cache_reads": "不含 cache 讀",
        "usage_cache_hit": "cache 命中",
        "usage_equiv_cost": "等效成本",
        "usage_entry_today": "今日 Token:",
        "usage_view_details": "檢視詳情",
        "usage_detail_title": "Token 用量詳情",
        "usage_range_days": "近 %d 天",
        "usage_trend_days": "近 %d 天趨勢",
        "usage_by_session_today": "今日依會話分佈",
        "usage_full_report": "完整報表…",
        "usage_stats_title": "Token 用量",
        "usage_stats_ellipsis": "Token 用量…",
        "usage_seg_day": "日",
        "usage_seg_week": "週",
        "usage_range_weeks": "近 %d 週 · 至 %@",
        "usage_tile_today": "今日 TOKENS",
        "usage_tile_cost": "等效 API 成本",
        "usage_tile_cache": "CACHE 命中率",
        "usage_tile_sessions": "活躍會話",
        "usage_delta_vs_yesterday": "vs 昨日同時段",
        "usage_week_cumulative": "本週累計 %@",
        "usage_cache_rw": "讀 %@ / 寫 %@",
        "usage_tools_in_use": "%d 個工具在用",
        "usage_chart_daily": "每日 Token 消耗 · 依工具",
        "usage_chart_weekly": "每週 Token 消耗 · 依工具",
        "usage_total_day": "當日合計",
        "usage_total_week": "當週合計",
        "usage_col_tool": "工具 / 模型",
        "usage_col_input": "Input",
        "usage_col_output": "Output",
        "usage_col_cache_write": "Cache 寫",
        "usage_col_cache_read": "Cache 讀",
        "usage_col_cost": "等效成本",
        "usage_col_share": "佔比",
        "usage_row_total": "合計",
        "usage_tool_other": "其他",
        "usage_sample_badge": "範例資料",
        "usage_footnote": "＊ 等效成本依各模型 API 定價折算，訂閱（Pro / Max）使用者實際不按此付費——它表示「同樣的用量走 API 要花多少」。價格表可在設定中更新。Cursor / Copilot 等 IDE 內建工具目前無法統計，未列入。",
        "usage_top_projects": "Top 專案",
        "usage_top_tools": "Top 工具",
        "usage_rank_others": "其他 %d 個",
        "usage_project_unknown": "未歸屬",
        "usage_pricing_override": "等效成本單價覆寫",
        "usage_pricing_override_desc": "JSON，單位 $/百萬 token——如 {\"opus-4-8\": {\"input\": 5, \"output\": 25}}。優先於內建價格表；留空則使用內建單價。",
        "usage_pricing_invalid": "JSON 無效——覆寫未生效",
        "usage_tab_report": "報表",
        "usage_tab_insight": "週報洞察",
        "usage_insight_hero_title": "本週 TOKEN 消耗",
        "usage_insight_hero_sub": "%@ 等效 API 成本",
        "usage_insight_vs_last_week": "vs 上週",
        "usage_insight_daily_avg_peak": "日均 %@ · 峰值週%@ %@",
        "usage_insight_heatmap_title": "活躍時段 · 每格 2 小時",
        "usage_insight_copy": "複製文案",
        "usage_insight_copied": "已複製",
        "usage_insight_empty": "本週暫無資料",
        "usage_insight_copy_line1": "本週 Token 消耗：%@（%@）",
        "usage_insight_copy_line1_no_cost": "本週 Token 消耗：%@",
        "usage_insight_copy_delta": "較上週：%@",
        "usage_insight_copy_projects": "Top 專案：%@",
        "usage_insight_copy_tools": "Top 工具：%@",
        "usage_insight_list_sep": "、",
        ...
        "allow_once": "允許一次",
        "browser_use_attention_title": "Browser Use",
        "browser_use_attention_possible": "可能需要確認",
        "browser_use_attention_body": "Codex 已發起頁面操作，請前往原工作階段查看",
        "browser_use_attention_note": "僅作提醒 · CodeIsland 不會代為確認",
        "browser_use_attention_open": "前往處理 →",
        "always": "一律允許",
    ...
    private static let ja: [String: String] = [
        ...
        "usage_entry_today": "本日の Token:",
        "usage_view_details": "詳細を見る",
        "usage_detail_title": "トークン使用量の詳細",
        "usage_range_days": "過去 %d 日",
        "usage_trend_days": "過去 %d 日の推移",
        "usage_by_session_today": "本日のセッション別",
        "usage_today": "今日",
        "usage_full_report": "詳細レポート…",
        ...
        "allow_once": "1回だけ許可",
        "browser_use_attention_title": "Browser Use",
        "browser_use_attention_possible": "確認が必要な可能性があります",
        "browser_use_attention_body": "Codex がページ操作を開始しました。元のセッションで確認してください。",
        "browser_use_attention_note": "通知のみ · CodeIsland は代理で確認できません",
        "browser_use_attention_open": "セッションを開く →",
        "always": "常に",
        ...
        // Usage stats window
        "usage_stats_title": "Token 使用量",
        "usage_stats_ellipsis": "Token 使用量…",
        "usage_seg_day": "日",
        "usage_seg_week": "週",
        "usage_range_weeks": "直近 %d 週 · %@ まで",
        "usage_tile_today": "本日の TOKENS",
        "usage_tile_cost": "API 換算コスト",
        "usage_tile_cache": "CACHE ヒット率",
        "usage_tile_sessions": "アクティブセッション",
        "usage_delta_vs_yesterday": "vs 昨日同時刻",
        "usage_week_cumulative": "今週累計 %@",
        "usage_cache_rw": "読 %@ / 書 %@",
        "usage_tools_in_use": "%d 個のツール使用中",
        "usage_chart_daily": "日別 Token 消費 · ツール別",
        "usage_chart_weekly": "週別 Token 消費 · ツール別",
        "usage_total_day": "当日合計",
        "usage_total_week": "当週合計",
        "usage_col_tool": "ツール / モデル",
        "usage_col_input": "Input",
        "usage_col_output": "Output",
        "usage_col_cache_write": "Cache 書",
        "usage_col_cache_read": "Cache 読",
        "usage_col_cost": "換算コスト",
        "usage_col_share": "割合",
        "usage_row_total": "合計",
        ...
        "usage_tab_report": "レポート",
        "usage_tab_insight": "週次インサイト",
        "usage_insight_hero_title": "今週の TOKENS",
        "usage_insight_hero_sub": "%@ 換算コスト",
        "usage_insight_vs_last_week": "vs 先週",
        "usage_insight_daily_avg_peak": "日平均 %@ ・ ピーク %@曜 %@",
        "usage_insight_heatmap_title": "アクティブ時間帯 · 1マス2時間",
        "usage_insight_copy": "テキストをコピー",
        "usage_insight_copied": "コピーしました",
        "usage_insight_empty": "今週のデータはまだありません",
        "usage_insight_copy_line1": "今週のトークン使用量：%@（%@）",
        "usage_insight_copy_line1_no_cost": "今週のトークン使用量：%@",
        "usage_insight_copy_delta": "先週比：%@",
        "usage_insight_copy_projects": "上位プロジェクト：%@",
        "usage_insight_copy_tools": "上位ツール：%@",
        "usage_insight_list_sep": "、",
    ]
    ...
    private static let ko: [String: String] = [
        ...
        "usage_entry_today": "오늘 토큰:",
        "usage_view_details": "상세 보기",
        "usage_detail_title": "토큰 사용량 상세",
        "usage_range_days": "최근 %d일",
        "usage_trend_days": "최근 %d일 추이",
        "usage_by_session_today": "오늘 세션별 분포",
        "usage_today": "오늘",
        "usage_full_report": "전체 리포트…",
        ...
        "allow_once": "한 번 허용",
        "browser_use_attention_title": "Browser Use",
        "browser_use_attention_possible": "확인이 필요할 수 있음",
        "browser_use_attention_body": "Codex가 페이지 작업을 시작했습니다. 원래 세션에서 확인하세요.",
        "browser_use_attention_note": "알림 전용 · CodeIsland는 대신 확인할 수 없습니다",
        "browser_use_attention_open": "세션 열기 →",
        "always": "항상",
        ...
        // Usage stats window
        "usage_stats_title": "토큰 사용량",
        "usage_stats_ellipsis": "토큰 사용량…",
        "usage_seg_day": "일",
        "usage_seg_week": "주",
        "usage_range_weeks": "최근 %d주 · %@까지",
        "usage_tile_today": "오늘 TOKENS",
        "usage_tile_cost": "API 환산 비용",
        "usage_tile_cache": "CACHE 적중률",
        "usage_tile_sessions": "활성 세션",
        "usage_delta_vs_yesterday": "vs 어제 같은 시간",
        "usage_week_cumulative": "이번 주 누계 %@",
        "usage_cache_rw": "읽기 %@ / 쓰기 %@",
        "usage_tools_in_use": "%d개 도구 사용 중",
        "usage_chart_daily": "일별 토큰 소비 · 도구별",
        "usage_chart_weekly": "주별 토큰 소비 · 도구별",
        "usage_total_day": "당일 합계",
        "usage_total_week": "해당 주 합계",
        "usage_col_tool": "도구 / 모델",
        "usage_col_input": "Input",
        "usage_col_output": "Output",
        "usage_col_cache_write": "Cache 쓰기",
        "usage_col_cache_read": "Cache 읽기",
        "usage_col_cost": "환산 비용",
        "usage_col_share": "점유율",
        "usage_row_total": "합계",
        "usage_tool_other": "기타",
        ...
        "usage_tab_report": "리포트",
        "usage_tab_insight": "주간 인사이트",
        "usage_insight_hero_title": "이번 주 TOKENS",
        "usage_insight_hero_sub": "%@ 환산 비용",
        "usage_insight_vs_last_week": "vs 지난주",
        "usage_insight_daily_avg_peak": "일 평균 %@ · 피크 %@요일 %@",
        "usage_insight_heatmap_title": "활성 시간대 · 칸당 2시간",
        "usage_insight_copy": "텍스트 복사",
        "usage_insight_copied": "복사됨",
        "usage_insight_empty": "이번 주 데이터가 아직 없습니다",
        "usage_insight_copy_line1": "이번 주 토큰 사용량: %@ (%@)",
        "usage_insight_copy_line1_no_cost": "이번 주 토큰 사용량: %@",
        "usage_insight_copy_delta": "지난주 대비: %@",
        "usage_insight_copy_projects": "상위 프로젝트: %@",
        "usage_insight_copy_tools": "상위 도구: %@",
        "usage_insight_list_sep": ", ",
    ]
    ...
    private static let tr: [String: String] = [
        ...
        "usage_entry_today": "Bugünkü token:",
        "usage_view_details": "Ayrıntıları gör",
        "usage_detail_title": "Token Kullanım Ayrıntıları",
        "usage_range_days": "Son %d gün",
        "usage_trend_days": "Son %d gün eğilimi",
        "usage_by_session_today": "Bugün oturuma göre",
        "usage_today": "Bugün",
        "usage_full_report": "Tam rapor…",
        ...
        "browser_use_attention_title": "Browser Use",
        "browser_use_attention_possible": "onay gerektirebilir",
        "browser_use_attention_body": "Codex bir sayfa işlemi başlattı. İncelemek için özgün oturumu açın.",
        "browser_use_attention_note": "Yalnızca hatırlatma · CodeIsland sizin yerinize onaylayamaz",
        "browser_use_attention_open": "OTURUMU AÇ →",
        "always": "HER ZAMAN",
        ...
        // Usage stats window
        "usage_stats_title": "Token Kullanımı",
        "usage_stats_ellipsis": "Token Kullanımı...",
        "usage_seg_day": "Gün",
        "usage_seg_week": "Hafta",
        "usage_range_weeks": "son %d hafta · %@ tarihine kadar",
        "usage_tile_today": "BUGÜNKÜ TOKEN",
        "usage_tile_cost": "EŞDEĞER API MALİYETİ",
        "usage_tile_cache": "CACHE İSABET ORANI",
        "usage_tile_sessions": "AKTİF OTURUMLAR",
        "usage_delta_vs_yesterday": "düne göre",
        "usage_week_cumulative": "bu hafta %@",
        "usage_cache_rw": "okuma %@ / yazma %@",
        "usage_tools_in_use": "%d araç kullanımda",
        "usage_chart_daily": "Günlük token · araca göre",
        "usage_chart_weekly": "Haftalık token · araca göre",
        "usage_total_day": "Gün toplamı",
        "usage_total_week": "Hafta toplamı",
        "usage_col_tool": "Araç / Model",
        "usage_col_input": "Input",
        "usage_col_output": "Output",
        "usage_col_cache_write": "Cache Y",
        "usage_col_cache_read": "Cache O",
        "usage_col_cost": "Maliyet",
        "usage_col_share": "Pay",
        "usage_row_total": "Toplam",
        ...
        "usage_tab_report": "Rapor",
        "usage_tab_insight": "Haftalık İçgörü",
        "usage_insight_hero_title": "BU HAFTAKİ TOKEN",
        "usage_insight_hero_sub": "%@ eşdeğer API maliyeti",
        "usage_insight_vs_last_week": "geçen haftaya göre",
        "usage_insight_daily_avg_peak": "Günlük ort. %@ · zirve %@ %@",
        "usage_insight_heatmap_title": "Aktif saatler · hücre başına 2 saat",
        "usage_insight_copy": "Metni kopyala",
        "usage_insight_copied": "Kopyalandı",
        "usage_insight_empty": "Bu hafta için henüz veri yok",
        "usage_insight_copy_line1": "Bu haftaki token kullanımı: %@ (%@)",
        "usage_insight_copy_line1_no_cost": "Bu haftaki token kullanımı: %@",
        "usage_insight_copy_delta": "Geçen haftaya göre: %@",
        "usage_insight_copy_projects": "En çok kullanılan projeler: %@",
        "usage_insight_copy_tools": "En çok kullanılan araçlar: %@",
        "usage_insight_list_sep": ", ",
    ]
}
